...
class Batcher(object):
  ...
  def text_generator(self, example_generator):
    while True:
      ...
      try:
        article_text = str(e.features.feature['article'].bytes_list.value[0]) # the article text was saved under the key 'article' in the data files
        abstract_text = str(e.features.feature['abstract'].bytes_list.value[0]) # the abstract text was saved under the key 'abstract' in the data files
      except ValueError:
